...
class Vtop___024root final : public VerilatedModule {
  public:
    ...
    VL_OUT8(seg6,7,0);
    VL_OUT8(seg7,7,0);
    CData/*0:0*/ top__DOT____Vcellout__alu__zero;
    CData/*0:0*/ top__DOT____Vcellout__alu__neg;
    CData/*0:0*/ top__DOT____Vcellout__alu__ow;
    CData/*0:0*/ top__DOT____Vcellout__alu__out_c;
    CData/*3:0*/ top__DOT____Vcellout__alu__out_s;
