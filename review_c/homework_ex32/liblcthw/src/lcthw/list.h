...
#define List_first(A) (A->first != NULL ? A->first->val : NULL)
#define List_last(A) (A->last != NULL ? A->last->val : NULL)

List *List_create();
void List_clear(List *list);    // Clear ListNode 's val
void List_destroy(List *list);  // Clear ListNode in List
